      ...
      <div class="container">
        <div class="content">
          <div class="col-2 date-time">
            <div class="heading"><blockquote> <ion-icon name="folder-outline"></ion-icon><Strong> Dashboard /- </Strong>Academic Calender</blockquote></div>
...
<!-- *****************Main-Content of the page********************************* -->
  ...
  <div class="schedule" style="text-align:center">
    <h2 class="profile-head">Academic Calender</h2>
    <%
    ...
    %>
    <img class="uploaded-image" src="displayCalenderImage?id=<%= 1 %>" alt="No Content!" width=800px height=800px>      
</div>
<!-- *****************End of main-content*********************** -->
