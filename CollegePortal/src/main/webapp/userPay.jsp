      ...
      <div class="container">
        <div class="content">
          <div class="col-2 date-time">
            <div class="heading"><blockquote> <ion-icon name="folder-outline"></ion-icon><Strong> Dashboard /- </Strong>Pay Online</blockquote></div>
          ...
          <div class="con-profile">
            <h2 class="profile-head">Make Payment</h2>
            <form action="">
              <!-- <div class="pay-img"> -->
              <span><h4 class="profile-head">QR Code</h4></span>
              <img
                class="profile-img"
                src="images/b.jpeg"
                alt="Profile Image"
              />
              <span><h4 class="profile-head">Bank Details</h4></span>
              <img
                class="profile-img"
                src="images/a.jpeg"
                alt="Profile Image"
