        ...
        <div class="content">
          <div class="col-2 date-time">
            <div class="heading">
              <blockquote>
                <ion-icon name="folder-outline"></ion-icon
                ><strong> Dashboard /- </strong>Academic Calender
              </blockquote>
            </div>
...
<div class="con-profile">
    <h2 class="profile-head">Academic Calendar</h2>
    <% 
    ...
    <img class="uploaded-image" src="displayImage?id=<%= id %>" alt="No Content! Uploaded Image" width=800px height=800px>
    <!-- Rest of your form -->
    <form action="calenderImage" method="post" enctype="multipart/form-data">
