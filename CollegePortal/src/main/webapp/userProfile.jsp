  ...
  <body>
    <section class="sec">
      <header class="head">
        ...
        <a class="user-link" href="user.jsp"><ion-icon class="user-link" name="log-out-outline"></ion-icon></a>
      </header>
      <nav class="nav-bar">
        <div class="side">
      ...
      <div class="container">
        <div class="content">
          <div class="col-2 date-time">
            <div class="heading"><blockquote> <ion-icon name="folder-outline"></ion-icon><Strong> Dashboard /- </Strong>My Profile</blockquote></div>
          ...
          <div class="con-profile">
            <h2 class="profile-head">Profile Editing</h2>
