...
<html lang="en">
  ...
  <body>
        ...
        <div class="content">
          <div class="col-2 date-time">
            <div class="heading">
              <blockquote>
                <ion-icon name="folder-outline"></ion-icon
                ><strong> Dashboard /- </strong>Notice
              </blockquote>
            </div>
    ...
    <img class="uploaded-image" src="noticeDisplay?id=<%= id %>" alt="No Content! Uploaded Image" width=800px height=800px>
    <!-- Rest of your form -->
    <form action="noticeImage" method="post" enctype="multipart/form-data">
