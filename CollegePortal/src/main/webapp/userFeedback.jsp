      ...
      <div class="container">
        <div class="content">
          <div class="col-2 date-time">
            <div class="heading"><blockquote> <ion-icon name="folder-outline"></ion-icon><Strong> Dashboard /- </Strong>Student Feedback</blockquote></div>
...
<!-- *****************Main-Content of the page********************************* -->
         ...
         <div class="con-feedback">
            <h2 class="profile-head">Share Your Feedback</h2>
            <form action="mailto:gkhushi0520@gmail.com" method="post">
              <input type="text" name="name" placeholder="Name" required />

             <!-- <input type="email" name="email" placeholder="Email" required /> -->

              <textarea name="message" placeholder="Message" cols="10" rows="10" required></textarea>
